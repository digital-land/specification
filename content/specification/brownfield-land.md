  ...
  - dataset: brownfield-land
    fields:
      - dataset-field: reference
        description: ''
        field: SiteReference
        guidance: "Enter the unique reference your organisation uses to identify the site. If one doesn’t exist, you need to create one. It should not be used by your organisation to identify any other sites, but can be borrowed from another data set listing the site. You could use the strategic site identifier from your local plan, for example: \\`EH/141\\`"
      - dataset-field: name
