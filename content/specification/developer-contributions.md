...
- dataset: developer-agreement
  description: A developer agreement is any legal document that secures contributions
    from a development for infrastructure or affordable housing (including section
    106 planning obligations and section 278 agreements), or any demand notice for
    CIL.
  fields:
  - field: reference
  - field: name
...
- dataset: developer-agreement-contribution
  description: Developer agreement contributions are the individual obligations or
    sums within an agreement, assigned to particular purposes such as affordable housing.
  fields:
  - field: reference
