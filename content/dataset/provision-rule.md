...
- field: include-exclude
  guidance: If this rule adds (includes) or removes (excludes) organisations from
    this rule.
...
- field: project
  guidance: Match all the organisations in the project-organisation with a project
    field of this value.
- field: provision-reason
  guidance: The reason why organisations included by this rule should provide this
    dataset.
