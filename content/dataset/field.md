...
- field: field
- field: guidance
  guidance: 'Enter guidance for a user providing the data.
    ...
    with the expectation it will form part of the content supporting mandating the
    provision
...
- field: name
- field: parent-field
  guidance: 'Enter the reference for the field from which this field is derrived.

    For example, the fields `target-dwellings` and `allocated-dwellings` both have
    the `parent-field` value of `dwelling-count`.
