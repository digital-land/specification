...
- field: EndDate
  guidance: 'If the site no longer needs to be listed (for example, if the site has
    ...
    brownfield land, in the format `YYYY-MM-DD`. This field should only be filled
    in
...
- field: PermissionType
  guidance: 'Choose one of the following to indicate what permission type the site
    ...
    * `other`
    ...
    The value `planning permission granted under an order` means planning permission
    granted
...
- field: PlanningStatus
  guidance: 'Choose one of the following to indicate what stage of the planning process
    ...
    * `pending decision`
    ...
    '
- examples:
  - value: Parcel of land behind, 221B Baker Street, Marylebone, London, NW1 6XE
