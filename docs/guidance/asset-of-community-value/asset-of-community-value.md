...
attachments:
- url: /specification/specification/asset-of-community-value
  name: 'Asset of community value technical specification (4 March 2025)'
  attachment-type: HTML
  start-date: 
---

^Follow this guidance when providing your Asset of community value data.^
...
so start by providing the Assets of community value information you have,
...
You will also need to update and republish your data whenever there's a change to your Assets of community value information.
...
Enter a CURIE value for the organisation from [this list](https://www.planning.data.gov.uk/organisation/).#### nomination-date
