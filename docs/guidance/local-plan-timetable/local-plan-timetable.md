...
^Follow this guidance when providing your local plan timetable data.^
...
so start by providing the local plan timetables information you have,
...
You will also need to update and republish your data whenever there's a change to your local plan timetables information.
...
(for example <code class="value">2027-01-01</code>)
...
(for example <code class="value">2027-03-31</code>)
#### entry-date
