---
title: Provide your development corporation boundary data
name: development corporation boundary
url: 
summary: 
...
attachments:
- url: /specification/specification/development-corporation-boundary
  name: 'Development corporation boundary technical specification (25 November 2025)'
  attachment-type: HTML
  start-date: 
---

^Follow this guidance when providing your development corporation boundary data.^
...
## Providing development corporation boundary data

Take the following steps to provide your development corporation boundary data:
...
so start by providing the best development corporation boundaries information you have,
...
The Development corporation boundary dataset contains the following fields:
...
You also need to update and republish your data whenever there's a change to your development corporation boundaries information.
