...
attachments:
- url: 
  name: 'Development policy technical specification (2023-04-05)'
...
You will also need to update and republish your data whenever there's a change to your Development policies information.
