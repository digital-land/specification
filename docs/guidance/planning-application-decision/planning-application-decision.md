...
attachments:
- url: /specification/specification/planning-application-decision
  name: 'Planning application decision technical specification (13 February 2025)'
...
so start by providing the Planning application decisions information you have,
...
You will also need to update and republish your data whenever there's a change to your Planning application decisions information.
...
Enter a CURIE value for the organisation from [this list](https://www.planning.data.gov.uk/organisation/).#### event-date
