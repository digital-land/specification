...
Your Planning condition data should also contain the following fields, where applicable:
...
Your Planning application condition data should also contain the following fields, where applicable:
