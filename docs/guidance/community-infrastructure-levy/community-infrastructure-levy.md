...
so start by providing the Community infrastructure levy information you have,
...
You will also need to update and republish your data whenever there's a change to your Community infrastructure levy information.
...
The Community infrastructure levy schedule dataset contains the following fields:
...
Enter a CURIE value for the organisation from [this list](https://www.planning.data.gov.uk/organisation/).#### adopted-date
