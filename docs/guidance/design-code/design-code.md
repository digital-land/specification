...
attachments:
- url: /specification/specification/design-code
  name: 'Design code technical specification (9 June 2022)'
  attachment-type: HTML
  start-date: 
---

^Follow this guidance when providing your Design code data.^
...
## Providing Design code data

Take the following steps to provide your Design code data:
...
so start by providing the best design codes information you have,
...
You also need to update and republish your data whenever there's a change to your design codes information.
