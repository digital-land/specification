...
so start by providing the design codes information you have,
...
You will also need to update and republish your data whenever there's a change to your design codes information.
