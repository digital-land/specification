...
so start by providing the best conservation areas information you have,
...
* [Conservation area](#Conservation-area-dataset)
* [Conservation area document](#Conservation-area-document-dataset)
...
Your Conservation area data should also contain the following fields, where applicable:
...
Your Conservation area document data should also contain the following fields, where applicable:
...
You also need to update and republish your data whenever there's a change to your conservation areas information.
...
[improving the design of this data](https://design.planning.data.gov.uk/consideration/conservation-areas),
