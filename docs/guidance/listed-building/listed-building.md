...
^Follow this guidance when providing your Listed building outline data.^
...
## Providing Listed building outline data
...
so start by providing the best Listed building outlines information you have,
...
The Listed building outline dataset contains the following fields:
...
You also need to update and republish your data whenever there's a change to your Listed building outlines information.
