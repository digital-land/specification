...
attachments:
- url: /specification/specification/infrastructure-funding-statement
  name: 'Infrastructure funding statement technical specification (23 November 2023)'
  attachment-type: HTML
  start-date: 
---

^Follow this guidance when providing your Infrastructure funding statement data.^
...
so start by providing the Infrastructure funding statements information you have,
...
You will also need to update and republish your data whenever there's a change to your Infrastructure funding statements information.
...
Enter a CURIE value for the organisation from [this list](https://www.planning.data.gov.uk/organisation/).#### period-start-date
