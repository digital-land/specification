...
attachments:
- url: /specification/specification/local-area-requirement
  name: 'Local area requirement technical specification (1 August 2024)'
  attachment-type: HTML
  start-date: 
---

^Follow this guidance when providing your Local area requirement data.^
...
## Providing Local area requirement data

Take the following steps to provide your Local area requirement data:
...
so start by providing the Local area requirements information you have,
...
You will also need to update and republish your data whenever there's a change to your Local area requirements information.
...
* [Local area requirements](#Local-area-requirements-dataset)
...
The Local area requirements dataset contains the following fields:
...
Enter a CURIE value for the organisation from [this list](https://www.planning.data.gov.uk/organisation/).#### document-urls
...
[improving the design of this data](https://design.planning.data.gov.uk/consideration/local-area-requirements),
